...
- **Light/Core 감상 기록** — 영화별 Light 질문 5개와 질문별 느낌 태그, Core 자유 감상, 자동 초안 복구와 수정·삭제
...
현재 외부 베타에서는 이메일 로그인, 취향 설정, 실시간 추천·검색, 영화 상세, 보고 싶어요 저장과 Light/Core 감상 기록까지 사용할 수 있습니다. 기록은 본인에게만 보이며 작성 중인 초안은 서버와 기기에 함께 보존됩니다.
...
- [x] 3C 준비 — AI 없이 영화 메타데이터로 질문 5개 구성, 질문별 최대 3개 태그 기록
- [ ] 3C AI — 선택 태그 정리·리뷰 초안 생성과 비용·안전장치
