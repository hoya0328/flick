<div align="center">
  ...
  **오늘의 감정으로 영화를 발견하고, 감상을 나의 언어로 남기는 영화 저널**
  ...
  ![Tests](https://img.shields.io/badge/Tests-28_Passing-117A55?style=flat-square)
</div>
...
1. 이메일 Magic Link로 로그인하거나 데모를 시작합니다.
...
- [x] **1단계** — Expo 기반, 이메일 로그인, 감정 키워드 온보딩
