...
현재 외부 베타에서는 이메일 로그인, 취향 설정, 실시간 추천·검색, 영화 상세, 보고 싶어요 저장, `나만 보기`/`전체 공개` Light/Core 감상 기록을 사용할 수 있습니다. Gemini 기반 Core 연계 질문과 Q5 답변 기반 리뷰 초안에는 사용자별 호출 제한·안전 필터·30일 감사 메타데이터가 적용되어 있습니다. 작성 중인 초안은 공개 선택과 관계없이 서버와 기기에 비공개로 보존됩니다.
...
- [ ] 4단계 외부 연결 — 계정 삭제 함수 운영 배포, TestFlight와 정식 출시 점검
